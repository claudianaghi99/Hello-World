...
namespace HelloWorldWeb.Tests
{
    public class WeatherControllerTests
    {
        ...
        public void TestCheckingConvertion()
        {
            ...
            Assert.Equal(25.260009765625, firstDay.Temperature);
